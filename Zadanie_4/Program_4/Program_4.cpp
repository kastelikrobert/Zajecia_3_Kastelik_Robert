...
GLuint GROUND, WOOD, ROOF, WIN;

// identyfikatory list wyświetlania

GLint GROUND_LIST, WOOD_LIST, ROOF_LIST, WIN_LIST;
...
void DisplayScene()
{
	...
	// filtr powiększający
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_REPLACE);
...
void GenerateTextures()
{
	...
	error = load_targa("wood.tga", width, height, format, type, pixels);
	//wall_wood_verti_color.tga
	// błąd odczytu pliku
	if (error == GL_FALSE)
	{
	...
	// wczytanie tekstury ground1-2.tga
	error = load_targa("win2.tga", width, height, format, type, pixels);
...
void GenerateDisplayLists()
{
	...
	WIN_LIST = glGenLists(1);

	// druga lista wyświetlania - okna chatki
	glNewList(WIN_LIST, GL_COMPILE);
	...
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-0.6, -0.0, 1.01);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(0.6, -0.0, 1.01);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(0.6, 1.0, 1.01);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-0.6, -0.0, 1.01);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(0.6, 1.0, 1.01);
	...
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-1.0, -0.0, -1.01);
	glTexCoord2f(2.0, 0.0);
	glVertex3f(1.0, -0.0, -1.01);
	glTexCoord2f(2.0, 1.0);
	glVertex3f(1.0, 1.0, -1.01);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-1.0, -0.0, -1.01);
	glTexCoord2f(2.0, 1.0);
	glVertex3f(1.0, 1.0, -1.01);
	...
	//// prawa boczna ściana
	glTexCoord2f(0.0, 1.0);
	glVertex3f(1.01, 1.0, -1.01);

	glTexCoord2f(2.0, 1.0);
	glVertex3f(1.01, 1.0, 1.01);

	glTexCoord2f(2.0, 0.0);
	glVertex3f(1.01, -0.0, 1.01);
