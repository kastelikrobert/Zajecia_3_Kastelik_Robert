...
GLint RECT_LIST;
GLint TEXTURE_512_LIST, TEXTURE_256_LIST, TEXTURE_128_LIST;
...
void GenerateDisplayLists()
{
	...
	// generowanie identyfikatora listy wyświetlania
	TEXTURE_512_LIST = glGenLists(1);

	// lista wyświetlania - tekstura o szerokości 256 tekseli
	glNewList(TEXTURE_512_LIST, GL_COMPILE);

	// definiowanie tekstury
	glTexImage1D(GL_TEXTURE_1D, 0, GL_RGB, 512, 0, GL_RGB, GL_UNSIGNED_BYTE, texture);
	...
	// definiowanie tekstury
	glTexImage1D(GL_TEXTURE_1D, 0, GL_LUMINANCE, 256, 0, GL_LUMINANCE, GL_UNSIGNED_BYTE, texture);
	...
	// definiowanie tekstury
	glTexImage1D(GL_TEXTURE_1D, 0, GL_INTENSITY, 128, 0, GL_RGB, GL_UNSIGNED_BYTE, texture);
